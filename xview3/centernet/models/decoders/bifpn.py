...
from pytorch_toolbelt.modules import EncoderModule, DecoderModule, get_activation_block, ACT_RELU
...
class BiFPN(DecoderModule):
    def __init__(self, feature_maps: List[int], strides: List[int], channels: int = 64, num_layers: int = 2, activation=ACT_RELU):
